...
func NewAuthProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Auth {
	...
	serviceURL += baseServicePath(pathPrefix, "recipes.auth", "Auth")
	urls := [1]string{
		serviceURL + "SayHello",
	}
...
func (c *authProtobufClient) SayHello(ctx context.Context, in *SayHelloRequest) (*SayHelloResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "recipes.auth")
...
const AuthPathPrefix = "/twirp/recipes.auth.Auth/"
...
func (s *authServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "recipes.auth.Auth" {
...
func (s *authServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "recipes.auth", "Auth")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
